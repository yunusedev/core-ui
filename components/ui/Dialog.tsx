...
export const DialogClasses = {
  ...
  content: [
    "z-[100] fixed border border-secondary overflow-hidden left-1/2 top-1/2 p-8 flex flex-col gap-6 rounded-lg bg-background-100 max-h-[85vh] min-w-[90vw] max-w-[95vw] lg:min-w-[300px] lg:max-w-xl outline-none -translate-x-1/2 -translate-y-1/2 bg-background",
